...
https://source.codeaurora.org/quic/la/kernel/lk/) (tag `LA.BR FIXME, also codelinaro?`),
which is a heavily modified version of the [Little Kernel Embedded Operating System].

## Supported SoCs and devices
Way too many socs. See Documentation/targets.md
A lot of devices. See Documentation/devices.md

See Documentation/porting.md if your device is not in the list.
...
See Documentation/building.md for more info.
